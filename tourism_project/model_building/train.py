...
Xtrain_path = "hf://datasets/kishoresowdi/visit-with-us/Xtrain.csv"
Xtest_path = "hf://datasets/kishoresowdi/visit-with-us/Xtest.csv"
ytrain_path = "hf://datasets/kishoresowdi/visit-with-us/ytrain.csv"
ytest_path = "hf://datasets/kishoresowdi/visit-with-us/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "best_predictive_model_v1.joblib"
    ...
    repo_id = "kishoresowdi/predictive-model"
    repo_type = "model"
    ...
    # create_repo("predictive-model", repo_type="model", private=False)
    api.upload_file(
        path_or_fileobj="best_predictive_model_v1.joblib",
        path_in_repo="best_predictive_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
